package com.mobilefuse.sdk.iab.gpp.encoder;
...
import com.mobilefuse.sdk.iab.gpp.encoder.error.InvalidFieldException;
import com.mobilefuse.sdk.iab.gpp.encoder.error.LazyDecodingException;
import com.mobilefuse.sdk.iab.gpp.encoder.field.TcfCaV1Field;
import com.mobilefuse.sdk.iab.gpp.encoder.field.TcfEuV2Field;
import com.mobilefuse.sdk.iab.gpp.encoder.field.UsCaV1Field;
import com.mobilefuse.sdk.iab.gpp.encoder.field.UsCoV1Field;
import com.mobilefuse.sdk.iab.gpp.encoder.field.UsCtV1Field;
import com.mobilefuse.sdk.iab.gpp.encoder.field.UsNatV1Field;
import com.mobilefuse.sdk.iab.gpp.encoder.field.UsUtV1Field;
import com.mobilefuse.sdk.iab.gpp.encoder.field.UspV1Field;
import com.mobilefuse.sdk.iab.gpp.encoder.field.UsVaV1Field;
import com.mobilefuse.sdk.iab.gpp.encoder.section.TcfCaV1;
import com.mobilefuse.sdk.iab.gpp.encoder.section.TcfEuV2;
import com.mobilefuse.sdk.iab.gpp.encoder.section.UsCaV1;
import com.mobilefuse.sdk.iab.gpp.encoder.section.UsCoV1;
import com.mobilefuse.sdk.iab.gpp.encoder.section.UsCtV1;
import com.mobilefuse.sdk.iab.gpp.encoder.section.UsNatV1;
import com.mobilefuse.sdk.iab.gpp.encoder.section.UsUtV1;
import com.mobilefuse.sdk.iab.gpp.encoder.section.UspV1;
import com.mobilefuse.sdk.iab.gpp.encoder.section.UsVaV1;
...
public class GppModelTest {
  ...
  @Test
  public void testEncodeDefault() throws EncodingException, LazyDecodingException {
  ...
  @Test
  public void testEncodeDefaultAll() throws EncodingException, InvalidFieldException, LazyDecodingException {
    GppModel gppModel = new GppModel();
  ...
  @Test
  public void testEncodeUspv1() throws EncodingException, InvalidFieldException, LazyDecodingException {
    GppModel gppModel = new GppModel();
    Assertions.assertEquals(false, gppModel.hasSection(UspV1.ID));
    Assertions.assertEquals(false, gppModel.hasSection(TcfEuV2.ID));
    Assertions.assertEquals(false, gppModel.hasSection(TcfCaV1.ID));
  ...
  @Test
  public void testEncodeTcfEuV2() throws EncodingException, InvalidFieldException, LazyDecodingException {
    GppModel gppModel = new GppModel();
    Assertions.assertEquals(false, gppModel.hasSection(UspV1.ID));
    Assertions.assertEquals(false, gppModel.hasSection(TcfEuV2.ID));
    Assertions.assertEquals(false, gppModel.hasSection(TcfCaV1.ID));
  ...
  @Test
  public void testEncodeUspV1AndTcfEuV2() throws EncodingException, InvalidFieldException, LazyDecodingException {
    GppModel gppModel = new GppModel();
    Assertions.assertEquals(false, gppModel.hasSection(UspV1.NAME));
    Assertions.assertEquals(false, gppModel.hasSection(TcfEuV2.NAME));
    Assertions.assertEquals(false, gppModel.hasSection(TcfEuV2.NAME));
  ...
  public void testEncodeUspV1AndTcfEuV2AndTcfCaV1()
      throws EncodingException, InvalidFieldException, LazyDecodingException {
    GppModel gppModel = new GppModel();
    Assertions.assertEquals(false, gppModel.hasSection(UspV1.ID));
    Assertions.assertEquals(false, gppModel.hasSection(TcfEuV2.ID));
    Assertions.assertEquals(false, gppModel.hasSection(TcfCaV1.ID));
  ...
  @Test
  public void testEncode1() throws EncodingException, InvalidFieldException, LazyDecodingException {
    GppModel gppModel = new GppModel();
  ...
  @Test
  public void testEncode2() throws EncodingException, InvalidFieldException, LazyDecodingException {
    GppModel gppModel = new GppModel();
  ...
  @Test
  public void testEncode3() throws EncodingException, InvalidFieldException, LazyDecodingException {
    GppModel gppModel = new GppModel();
