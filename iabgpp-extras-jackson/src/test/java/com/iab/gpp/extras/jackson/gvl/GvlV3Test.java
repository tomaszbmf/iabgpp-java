...
public class GvlV3Test {

  @Test
  public void test() throws IOException {
    Gvl gvl = new Loader()
        .globalVendorList(GvlV3Test.class.getClassLoader().getResourceAsStream("vendorlist/v3.0/vendor-list.json"));
    ...
    Assertions.assertFalse(gvl.getPurposes().get(0).getDescriptionLegal().isPresent());
    ...
    Assertions.assertFalse(gvl.getSpecialPurposes().get(0).getDescriptionLegal().isPresent());
    ...
    Assertions.assertFalse(gvl.getFeatures().get(0).getDescriptionLegal().isPresent());
    ...
    Assertions.assertFalse(gvl.getSpecialFeatures().get(0).getDescriptionLegal().isPresent());
    ...
    Assertions.assertFalse(gvl.getVendors().get(0).getPolicyUrl().isPresent());
    ...
    Assertions.assertEquals(Arrays.asList(1, 3, 4, 6, 8, 10, 11), gvl.getVendors().get(0).getDataDeclaration().get());
    ...
    Assertions.assertEquals(Arrays.asList(1),  gvl.getVendors().get(4).getSpecialFeatures());
    Assertions.assertFalse(gvl.getVendors().get(4).getPolicyUrl().isPresent());
    ...
    Assertions.assertEquals(Arrays.asList(1, 2, 3, 4, 6, 8, 9, 11), gvl.getVendors().get(4).getDataDeclaration().get());
